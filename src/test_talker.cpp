 ...
 * @brief This file contains code to test the talker node
 * Here two conditions are checked:
 * 1. Is message being published in /chatter topic?
 * 2. The string data in chatter topic is "I;m not set"
 * @version 1.0
 */
...
/**
 * @brief TestTalker node class
 *
 * @details The TestTalker class contains unit tests to test the talker class if
 * it is publishing in /chatter
 */
